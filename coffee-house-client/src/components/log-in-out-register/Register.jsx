    ...
    >
      ...
      <div className="flex justify-center items-center flex-1 px-4">
        ...
        <div className="w-full max-w-md bg-white/30 backdrop-blur-md rounded-2xl shadow-xl p-8">
          <h2 className="text-4xl font-rancho font-bold text-center text-[#331a15] mb-6">
            Register
          </h2>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="px-8 py-2 mt-4 rounded-full border-2 border-[#331A15] text-[#331A15] font-semibold text-lg hover:bg-[#331A15] hover:text-white transition-all duration-300 font-rancho"
              >
                Register
              </button>
            </div>
          ...
          <p className="text-center text-sm mt-5 text-[#331a15]">
            ...
            <Link to={"/user/login"} className="text-[#331a15] font-rancho font-semibold">
              Login
            </Link>
          </p>
        </div>
